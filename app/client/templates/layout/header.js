...
Template['layout_header'].helpers({
    ...
    */
    'goToSend': function() {
        ...
        var address = webu.toChecksumAddress(FlowRouter.getParam('address'));
        var accounts = HucAccounts.find({}).fetch();
    ...
    */
    'timeSinceBlock': function () {
        ...
        if (HucBlocks.latest.timestamp == 0
            || typeof HucBlocks.latest.timestamp == 'undefined')
            return false;
