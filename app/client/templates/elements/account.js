...
Template['elements_account'].helpers({
    ...
    */
    'account': function(){
        return HucAccounts.findOne(this.account) || Wallets.findOne(this.account) || CustomContracts.findOne(this.account);
    },
    /**
    Get all tokens
    ...
    'new': function() {
        if(this.new) {
            ...
            Meteor.setTimeout(function() {
                HucAccounts.update(id, {$unset: {new: ''}});
    ...
    */
    'creating': function(){
        ...
        var belowReorgThreshold = (blocksForConfirmation >= HucBlocks.latest.number - (this.creationBlock - 1));
        var blockNumberCheck = HucBlocks.latest.number - (this.creationBlock - 1) >= 0;
    ...
    */
    'unConfirmed': function() {
        ...
        var currentBlockNumber = HucBlocks.latest.number,
